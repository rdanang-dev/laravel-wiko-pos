                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-custom">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <span class="kd-barang-field">kode</span><br><br>
                                            <span class="nama-barang-field">nama</span>
                                        </td>
                                        <td>jenis_barang</td>
                                        <td>berat_barang</td>
                                        <td>merek</td>
                                        <td><span class="ammount-box bg-secondary"><i
                                                    class="mdi mdi-cube-outline"></i></span>stok</td>
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                data-toggle="modal" data-target="#editModal" data-edit="#">
